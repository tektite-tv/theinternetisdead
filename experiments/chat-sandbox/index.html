...
function registerPageCommands(){
    postToChatSandbox({
        ...
        commands: [
            ...
            { name: '/clock_zone', usage: '/clock_zone ', desc: 'sync the overlay clock to a named timezone', execute: false, suggestions: allClockZones }
        ]
    });
}
