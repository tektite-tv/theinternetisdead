...
<style>
  ...
  body.controller-active #startMenu #btnStats.controllerFocus::after{
    ...
    background-image:url('/dead/games/shooter-game/assets/controller-buttons/button-a.webp');
  ...
  body.controller-active #startMenu #btnMenu::after{
    background-image:url('/dead/games/shooter-game/assets/controller-buttons/menu.webp');
  }
...
body.invert-colors {
  ...
  *:active{
  ...
  #menuHubTopButtons::before{
    left:4px;
    background-image:url("/dead/games/shooter-game/assets/controller-buttons/left-bumper.webp");
  }
  #menuHubTopButtons::after{
    right:4px;
    background-image:url("/dead/games/shooter-game/assets/controller-buttons/right-bumper.webp");
  }
...
<style id="hubControlsMatchHubMenuPurpleSurface">
  ...
  <style id="startMenuControllerGlyphsInlineBesideText">
    ...
    body.controller-active #startMenu.panel.shooter-menu16x9Surface #btnStart.controllerFocus::after,
    body.controller-active #startMenu.panel.shooter-menu16x9Surface #btnStart.controller-selected::after{
      background-image:url('/dead/games/shooter-game/assets/controller-buttons/button-a.webp') !important;
    }

    body.controller-active #startMenu.panel.shooter-menu16x9Surface #btnMenu::after,
    body.controller-active #startMenu.panel.shooter-menu16x9Surface #btnMenu.controllerFocus::after,
    body.controller-active #startMenu.panel.shooter-menu16x9Surface #btnMenu.controller-selected::after{
      background-image:url('/dead/games/shooter-game/assets/controller-buttons/menu.webp') !important;
    }
  </style>
...
<img src="/dead/games/shooter-game/assets/bananarama.webp" alt="Level 2 player icon">
...
<div class="optRow fullRow">
  ...
  <div id="controlsPreviewMenu" class="panel" style="display:none;" aria-label="Controller input preview">
    ...
    <iframe id="controlsPreviewFrame" src="/dead/games/shooter-game/assets/controller-buttons/controls.html" title="Xbox One controller input preview" allow="gamepad" tabindex="0"></iframe>
...
<script src="/dead/games/shooter-game/assets/scripts/level1-runtime.js"></script>
<script src="/dead/games/shooter-game/assets/scripts/time-easter-egg.js"></script>
<script src="/dead/games/shooter-game/assets/scripts/level1-win-fallbacks.js"></script>
