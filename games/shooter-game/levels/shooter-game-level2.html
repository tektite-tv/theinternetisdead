...
<style>
  ...
  #controlsMenu .controlsGrid{ display:grid; gap:6px; text-align:left; width:100%; min-width:0; }
  #controlsMenu .optRow{ padding:6px 8px; }
  #controlsMenu .controlsHeaderRow{ border:none; background:transparent; padding:0; }
  #controlsMenu .controlsHeaderRow .hint{ padding:0 2px; }
  #controlsMenu .hint{ margin-top:3px; line-height:1.15; font-size:10px; }
  #controlsMenu .controlsModeTabs{ display:grid; grid-template-columns:minmax(0, 1fr) minmax(0, 1fr); gap:6px; margin:0 0 6px; align-items:stretch; width:100%; min-width:0; }
  #controlsMenu .controlsModeTabs button{ display:flex; align-items:center; justify-content:center; min-width:0; width:100%; max-width:100%; flex:none; box-sizing:border-box; padding:9px 10px; font-size:13px; line-height:1.2; text-align:center; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
  #controlsMenu .controlsModeTabs button.active{ background: rgba(0,255,102,0.16); border-color: rgba(0,255,102,0.65); }
  ...
  #controlsMenu .controlsBindMeta{ display:flex; flex-direction:column; gap:1px; min-width:0; }
  ...
  #controlsBindStatus{ margin-top:2px; min-height:24px; font-size:10px; }
  #controlsFixedInfo{ margin-top:3px; line-height:1.15; font-size:10px; }
  ...
  @media (max-width: 640px), (max-height: 760px){
    ...
    #controlsBindStatus,
    #controlsFixedInfo,
    #controlsMenu .hint{ font-size:9px; }
  }
  ...
  #optionsMenu .checkOption .hint{ margin-top:0; padding-left:28px; }
...
<div id="pauseOverlay">
  <div id="pausePanel">
    ...
    <button id="btnPauseResume" class="pauseMenuBtn" style="font-size:18px;">Resume</button>
    <button id="btnPauseOpenChat" class="pauseMenuBtn" type="button" style="font-size:18px;">Controls</button>
...
<div id="uiRoot">
  <div id="startMenu" class="panel" style="background: rgba(75,0,118,0.72); border-width: 3px; display:none;">
    ...
    <div class="titleSubWrap">
      <div class="titleSub"><span class="titleSubDefault">(Maze Mode)</span><span class="titleSubHover">(Level 2)</span></div>
    </div>
  ...
  <div id="controlsMenu" class="panel" style="display:none;">
    ...
    <div class="controlsGrid">
      <div class="optRow controlsHeaderRow">
        <div class="controlsModeTabs">
          <button id="controlsModeKeyboard" class="smallBtn active" type="button">Keyboard / Mouse</button>
          <button id="controlsModeController" class="smallBtn" type="button">Controller</button>
        </div>
        <div id="controlsBindStatus" class="hint">Select a control to rebind.</div>
        <div id="controlsFixedInfo" class="hint">Aim stays on mouse/touch. Stick aim and D-pad navigation stay fixed on controller.</div>
      </div>
      <div class="optRow">
...
if (btnReturnToLevel1){
  btnReturnToLevel1.addEventListener("click", () => {
    ...
    window.location.href = "/games/shooter-game/levels/shooter-game-level1.html?reload=" + Date.now();
  });
}
...
if (btnSkipToLevel3){
  btnSkipToLevel3.addEventListener("click", () => {
    ...
    setAssetStatus(msg);
    const statusEl = document.getElementById("controlsBindStatus");
