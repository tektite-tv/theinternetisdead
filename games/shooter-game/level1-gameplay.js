...
<style>
  ...
  #optionsMenu.panel{ width:min(640px, 94vw); padding:12px 12px 10px; background: rgba(75,0,118,0.72); max-height:none; overflow:visible; scrollbar-width:none; -ms-overflow-style:none; transform-origin:center center; }
...
<div id="winOverlay">
  <div id="winPanel">
    ...
    <button id="btnContinue">Continue to Level 2</button>
  </div>
</div>
...
<div id="uiRoot">
  <div id="startMenu" class="panel" style="background: rgba(75,0,118,0.72); border-width: 3px;">
    <div class="title">Tektite's Bananaman Shooter Game</div>
    <div class="titleSubWrap">
      <div class="titleSub"><span class="titleSubDefault">(New and Improved)</span><span class="titleSubHover">(Last updated: 2026-04-12 18:06 UTC)</span></div>
    </div>
  ...
  <div id="optionsMenu" class="panel" style="display:none;">
    ...
    <div class="optionsGrid">
      ...
      <div class="optRow">
        <div class="optLabel"><span>Starting Hearts</span><span id="heartsVal">3</span></div>
        <input id="heartsSlider" type="range" min="1" max="12" value="3" step="1" />
...
<script src="./scripts/level1-gameplay.js"></script>
<script src="./scripts/level1-ui.js"></script>
<script src="./scripts/level1-controls.js"></script>
<script>
/* =======================
   Boot
======================= */
